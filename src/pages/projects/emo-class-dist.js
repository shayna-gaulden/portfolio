    ...
    <div>
      ...
      <div className="margin-div">
        ...
        <div className="proj-detail-box">
          ...
          represented. This project will take a data set with single-label
          emotion classes and transform the single-label binary membership
          vectors into continuous valued emotion distribution vectors. The
          findings of this study will show that when using a transformer model
          the data should not be over-processed with steps such as stop word
          removal. The conversion from single-label to a distribution vector
          does not improve overall classification quality, although it has
          special interpretations regarding a richer representation of the data,
          and can be used to increase the classification accuracy for specific
          emotion classes.
        </div>
      </div>
