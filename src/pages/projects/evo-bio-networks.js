      ...
      <div>
        ...
        <div className="margin-div">
          <Title
            ...
            subtitle={
              "Shayna Gaulden | Mar 2020 - May 2021 | Python Research Project"
            }
          />
          <a
            href="https://github.com/shayna-gaulden/graphing-dispersal-death-processes"
            target="_blank"
            rel="noreferrer"
          ...
          <div className="section-gallery">
            <div className="section-container">
              <div className="left">
                <header className="section-title">Contributors</header>
              </div>
              <div className="right">
            ...
            {Project1Data1.map((el) => {
              return <Section title={el.title} body={el.body} />;
            })}
          </div>
          <div className="section-gallery">
            ...
            <div className="section-container">
              <div className="left">
                <header className="section-title">Fecundity</header>
              </div>
              <div className="right">
                <body className="section-body">
                  <img
            ...
            <div className="section-container">
              <div className="left">
                <header className="section-title">Survival</header>
              </div>
              <div className="right">
                <body className="section-body">
                  <img
          ...
          <div className="gallery">
            <ProjImg
              img={Img1}
              fig="Figure 1. Initial graph with 500 vertices randomly dispersed."
            />
            <ProjImg
              img={Img2}
              fig="Figure 2. Graph with 4833 vertices after 1,000 iterations."
            />
            <ProjImg
              img={Img3}
              fig="Figure 3. Graph with 7171 vertices after 10,000 iterations."
            />
            <ProjImg
              img={Img4}
              fig="Figure 4. Graph with 7842 vertices after 100,000 iterations."
            />
          </div>
